 ...
 */
public class SubscribeFragment extends BaseFragment implements NewsListAdapter.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener{
    ...
    private String mApiTitle;
    public static final String ARG_PARAM_API_TYPE = "ApiType";
    public static final String ARG_PARAM_API_TITLE = "ApiTitle";

    public static SubscribeFragment newInstance(int apiType,String title) {
        SubscribeFragment fragment = new SubscribeFragment();
        Bundle bundle = new Bundle();
        bundle.putInt(ARG_PARAM_API_TYPE, apiType);
        bundle.putString(ARG_PARAM_API_TITLE,title);
    ...
    @Override
        protected void onCreated(Bundle savedInstanceState) {
            ...
            mApiTitle= getArguments().getString(ARG_PARAM_API_TITLE);
            ...
            ArrayList<Item> items = App.cacheHelper.getAsSerializable(mApiTitle);
            if (items !=null){
        ...
        private void initNetWorkData(){
            ...
            HttpMethods.getInstance().getColumnData(new Subscriber<Rss>() {
                @Override
                ...
                public void onNext(Rss rss) {
                    ...
                    handleResultData(items);
                    App.cacheHelper.put(mApiTitle,(Serializable)items);
                }
            },mApiType);
